...
const file_todo_todo_proto_rawDesc = "" +
	"\n" +
	"\x0ftodo/todo.proto\x12\x04todo\x1a\x1cgoogle/api/annotations.proto\"l\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\fCompleteTask\x12\x19.todo.CompleteTaskRequest\x1a\x1a.todo.CompleteTaskResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\x1a\x17/v1/tasks/{id}/completeB\x17Z\x15hearx/proto/todo;todob\x06proto3"
